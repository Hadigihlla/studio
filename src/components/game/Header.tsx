...
export function Header() {
  return (
    <header className="mb-6 pb-4 border-b-2 border-primary/20 md:mb-8 md:pb-6">
      <div className="flex justify-center items-center gap-2 md:gap-4">
       ...
       <p className="mt-2 text-center text-base md:text-xl font-semibold text-muted-foreground">
